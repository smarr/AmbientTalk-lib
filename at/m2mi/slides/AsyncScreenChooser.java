 ...
 * @version 07-Oct-2003
 */
public class AsyncScreenChooser
...
// Hidden data members.
	...
	private AsyncScreen mySelectedTheatre;
...
// Exported constructors.
	 ...
	 */
	public AsyncScreenChooser
		(AsyncScreenSelectionListener theListener)
		{
	...
	public synchronized void valueChanged
		...
		if (myJList != null)
			...
			if (index == -1)
				...
				{
				theatre = (AsyncScreen) myHandles.elementAt (index);
