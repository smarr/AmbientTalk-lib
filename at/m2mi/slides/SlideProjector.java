...
// Hidden constructors.
	 ...
	 */
	public SlideProjector(ATReplacementFactory factory)
		{
		...
		mySlideShow = null;
		try {
			myProjectorObject = factory.makeProjector();
		} catch (Exception e1) {
			System.err.println("ERROR wrapping projector in AT object:"+e1.getMessage());
			e1.printStackTrace();
		}
