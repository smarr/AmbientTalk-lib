...
public class ScreenObject
	implements Screen, ScreenObjectI
	{

// Hidden helper classes.

	public interface ATFetcher extends EventListener {
		public void fetch(Projector p, Eoid slideId);
	}
...
// Exported operations.
	...
	/* (non-Javadoc)
	 * @see at.m2mi.slides.ScreenObjectI#availableSlides(at.m2mi.slides.Projector, edu.rit.m2mi.Eoid[])
	 */
	...
	/* (non-Javadoc)
	 * @see at.m2mi.slides.ScreenObjectI#displaySlides(at.m2mi.slides.Projector, edu.rit.m2mi.Eoid[])
	 */
	...
	private synchronized void fetchNextSlide
		...
		if (theTimer.isTriggered())
			...
			if (descriptor != null)
				...
				myFetcher.fetch(descriptor.getProjector(), descriptor.getSlideID());
